...
print ("[INFO] Pi home survellence warming up")
time.sleep(conf["camera_warmup_time"])
avg = None
lastUploaded = datetime.datetime.now()
motionCounter = 0
print('[INFO] Pi home survellence started !!')
...
for f in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	cnts,im2 = cv2.findContours(thresh.copy(), cv2.RETR_EXTERNAL,
	...
	if text == "Occupied":
                ...
                cv2.imwrite("/tmp/raspihomesurveillance_{}.jpg".format(motionCounter), frame);
